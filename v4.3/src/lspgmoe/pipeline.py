...
def parse_args() -> argparse.Namespace:
    ...
    for command in ["build-data", "recurate-data", "run", "smoke", "baselines", "ablations", "interpret", "robustness", "revision", "audit-duplicates", "validate-import", "extract-jats", "extract-cross-jats", "extract-polymer-jats", "extract-textile-jats", "extract-pla-jats", "extract-carbon-jats", "extract-facemask-jats", "extract-chitosan-jats", "merge-staged"]:
...
def main() -> None:
    ...
    if args.command == "build-data":
    ...
    elif args.command == "recurate-data":
        from .recuration import build_recurated_dataset

        result = build_recurated_dataset(args.config)
        ...
        result = run_revision(args.config)
